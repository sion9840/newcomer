...
class AddNewPersonScreen extends StatefulWidget {
  @override
  _AddNewPersonScreenState createState() => _AddNewPersonScreenState();
}
...
class _AddNewPersonScreenState extends State<AddNewPersonScreen> {
  ...
  File? new_comer_img_file = null;//새가족 사진
            ...
            actions: <Widget>[
              TextButton(
                ...
                onPressed: () async{
                  ...
                  var enr_card_file_url = "new_comers/cards/${id}_enr_card.png";
                  var new_comer_img_file_url = "new_comers/imgs/${id}_new_comer_img.png";
                  ...
                  await firestoreInstance
                      ...
                      .set(
                      {
                        ...
                        "new_comer_img_file_url" : new_comer_img_file_url,
                                                            ...
                                                            child: Builder(
                                                                builder: (context) {
                                                                  if(edu_state[i] == 0){
                                                                    ...
                                                                    return Text(
                                                                      "${i+1}차\n${edu_state[i]["date"].month}/${edu_state[i]["date"].day}",
                                                                      style: TextStyle(
                                                                        color: Color(CtTheme.white_color),
                                                                        fontSize: CtTheme.small_font_size-2,
                                                                      ),
                                                                                                ...
                                                                                                SizedBox(
                                                                                                  ...
                                                                                                  child: ElevatedButton(
                                                                                                    ...
                                                                                                    onPressed: () {
                                                                                                      ...
                                                                                                      edu_state[i]["date"] = selected_date;
                                        ...
                                        child: Builder(
                                            builder: (context) {
                                              ...
                                              for(int i = 0; i<attend_worship_state.length; i++){
                                                String temp_year = attend_worship_state[i]["date"].year.toString();
                                                String temp_month = attend_worship_state[i]["date"].month.toString();
                                                String temp_day = attend_worship_state[i]["date"].day.toString();
                                                      ...
                                                      child: Center(
                                                        child: SizedBox(
                                                          ...
                                                          child: ElevatedButton(
                                                            ...
                                                            child: Text(
                                                              "${attend_worship_state[i]["date"].month}/${attend_worship_state[i]["date"].day}\n${display_text}",
                                                              style: TextStyle(
                                                                color: Color(CtTheme.white_color),
                                                                fontSize: CtTheme.small_font_size-2,
                                                              ),
                                                            ...
                                                            children: [
                                                              Expanded(
                                                                child: Container(
                                                                  decoration: BoxDecoration(
                                                                      image: DecorationImage(
                                                                          image: FileImage(new_comer_img_file!),
                                                                          fit: BoxFit.contain)),
                                                                ),
                                                              ),
                                                              SizedBox(height: CtTheme.middle_padding,),
                            ...
                            children: <Widget>[
                              Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    calSunMoonToDisplayText(Division.young)!,
                                    style: TextStyle(
                                      color: Color(CtTheme.black_color),
                                      fontSize: CtTheme.small_font_size,
                                    ),
                              ...
                              Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    calSunMoonToDisplayText(Division.old)!,
                                    style: TextStyle(
                                      color: Color(CtTheme.black_color),
                                      fontSize: CtTheme.small_font_size,
                                    ),
